    ...
    return (
        <>
            <div className="row" style={{ display: 'flex', flexDirection: 'row' }}>
                <div className="col" style={{ textAlign: 'left', marginLeft: '6rem' }}>
                    <div className="row">
                    ...
                    <div className="row" style={{ marginLeft: '0rem' }}>
                        ...
                        <ul className="online shopping" style={{ color: 'black', textDecoration: 'none', listStyle: 'none', lineHeight: '1rem', fontSize: '.8rem', marginLeft: '-1rem' }}>
                ...
                <div className="col"  >
                    ...
                    <div className="row" style={{ display: 'flex', flexDirection: 'row' }} >
                        ...
                        <div className="col" style={{ marginLeft: '8rem' , marginTop: '-3.5rem'}}>
                            <div style={{ marginTop: '1rem' }}>
